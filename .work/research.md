...
## Core concepts
  ...
  * Design taxonomy: predefined tokens/variables/axes
  * Controls
    * Canonic CSS/HTML structure to populate (not write from scratch)
  * Settings sets - classical configuring tasks
